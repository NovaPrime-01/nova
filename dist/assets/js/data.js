...
window.NOVA_DATA = {
  ...
  about: {
    ...
    facts: [
      { label: "Based in", value: "[REPLACE: City, Country]" },
      { label: "Focus", value: "Gaming · Technology · Design" },
      { label: "Working since", value: "[REPLACE: Year]" },
      { label: "Status", value: "Open to collaborations" },
    ],
    timeline: [
      { year: "[REPLACE: Year]", text: "Started creating content and exploring digital projects." },
      { year: "[REPLACE: Year]", text: "Began competitive gaming and built the NOVA eSports identity." },
      { year: "[REPLACE: Year]", text: "Expanded into design, branding and technology experiments." },
